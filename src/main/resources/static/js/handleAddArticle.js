...
//Pridanie funkcionality pre tlacidla"

document.getElementById("insert").addEventListener("click", () =>{
    setTimeout(function(){
        document.getElementById("addArticleForm").addEventListener("submit",event =>{
                event.preventDefault();
                addNewArticle("router-view","template-article",serverUrlBase);
            }
        );
...
function addNewArticle(outputEmlId, outputTmplId) {
    ...
    const newArtData = {
        ...
        tags: document.getElementById("tagsAdd").value.trim().concat(",jacobovClanok")
    };
